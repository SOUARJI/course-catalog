...
const categories = ["All", "C++ Programming", "System Configuration", "Code Quality", "Debugging", "Development Tools", "Team Onboarding"];
    ...
    <Box sx={{ minHeight: '100vh' }}>
      ...
      <AppBar position="fixed" elevation={2}>
        <Toolbar>
          ...
          {/* Amadeus Logo */}
          <Tooltip title="Amadeus">
            <IconButton
              color="inherit"
              onClick={toggleDarkMode}
              aria-label="Amadeus Logo"
              data-testid="button-amadeus-logo"
              sx={{ 
                fontWeight: 'bold', 
                fontSize: '1.2rem',
